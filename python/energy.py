...
print(f"    Low Mode:    {'%.2f' % round(energy[0][0], 2)} Energy | {'%.2f' % round(energy[0][0] / epd, 2)} Days")
print(f"    Average:     {'%.2f' % round(energy[1][0], 2)} Energy | {'%.2f' % round(energy[1][0] / epd, 2)} Days")
print(f"    High Mode:   {'%.2f' % round(energy[2][0], 2)} Energy | {'%.2f' % round(energy[2][0] / epd, 2)} Days")
print(f"MANIA:      {maniatemp}")
print(f"    Low Mode:    {'%.2f' % round(energy[0][1], 2)} Energy | {'%.2f' % round(energy[0][1] / epd, 2)} Days")
print(f"    Average:     {'%.2f' % round(energy[1][1], 2)} Energy | {'%.2f' % round(energy[1][1] / epd, 2)} Days")
print(f"    High Mode:   {'%.2f' % round(energy[2][1], 2)} Energy | {'%.2f' % round(energy[2][1] / epd, 2)} Days")